...
func NewRegistrar(client Client, service Service) *Registrar {
	service.Key = service.Prefix + "/" + service.Key
	return &Registrar{
		client:  client,
		service: service,
	}
...
func (r *Registrar) Register() {
	...
	if r.service.TTL != nil {
		log.Println("action", "register", "lease", r.client.LeaseID())
	} else {
...
func (r *Registrar) GetEntries() ([]string, error) {
	return r.client.GetEntries(r.service.Prefix)
}
